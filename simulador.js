...
//let ordenarMenor = document.getElementById("ordenarMenor");
const ordenarXMenor = ()=>{
...
//ordenarMenor.addEventListener("click", ordenarXMenor);
...
//ordenarMayor.addEventListener("click", ordenarXMayor);
...
const limpiarHTML = ()=>{
    ...
    //document.getElementById("filaProductos").appendChild(fila);
    $("#fila").empty(fila);
...
//let enviarMaxMin = document.getElementById("enviarMaxMin");
//enviarMaxMin.addEventListener("click", filtrarMaxMin);
